...
myTransform.description="H264 content aware encoding built-in preset"
...
job_name = 'MyEncodingH264ContentAwareJob'+ uniqueness
print(f"Creating Encoding264ContentAware job {job_name}")
files = (source_file)
