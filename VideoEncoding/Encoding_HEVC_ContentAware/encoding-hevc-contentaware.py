...
myTransform.description="HEVC (H.265) content aware encoding built-in preset"
...
#<CreateJob>
job_name = 'MyEncodingHEVCContentAwareJob'+ uniqueness
print(f"Creating EncodingHEVCContentAware job {job_name}")
files = (source_file)
